  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-300 font-sans selection:bg-cyan-500/30 selection:text-cyan-200 overflow-x-hidden relative">
      ...
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[20%] w-[600px] h-[600px] bg-cyan-500/10 rounded-full blur-[120px] mix-blend-screen opacity-50"></div>
        <div className="absolute bottom-[-10%] right-[10%] w-[500px] h-[500px] bg-violet-600/10 rounded-full blur-[100px] mix-blend-screen opacity-50"></div>
        {/* Grid Overlay */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-24 pb-20">
        ...
        <header className="mb-24 border-l-2 border-cyan-500/50 pl-8 md:pl-12 py-4 relative">
          ...
          <h1 className="text-5xl md:text-8xl font-bold text-white tracking-tighter mb-4 uppercase break-words">
            {fullName}
          </h1>
        ...
        <section className="mb-32">
          ...
          <div className={`grid ${gridClasses}`}>
            {projects && projects.length > 0 ? (
              projects.map((project, index) => {
                ...
                return (
                  <div key={index} className="group relative bg-slate-900/50 border border-slate-800 hover:border-cyan-500/50 transition-all duration-500 rounded-xl overflow-hidden">
                    ...
                    {/* IMAGE AREA */}
                    <div className="h-64 md:h-80 w-full overflow-hidden relative bg-slate-900">
                       ...
                       {bgImage ? (
                         ...
                         <div className="w-full h-full flex items-center justify-center text-slate-700 font-mono text-xs uppercase tracking-widest">
                            No Signal
                         </div>
                       )}
              ...
              <div className="col-span-full text-slate-600 italic font-mono text-sm">
        ...
        <footer className="border-t border-slate-800 pt-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               {contact && contact.length > 0 ? (
                 ...
                 <div className="text-slate-600 italic font-mono text-sm p-4">
                   // Offline
                 </div>
               )}
             </div>
          ...
          <div className="mt-20 flex justify-between items-end text-[10px] font-mono text-slate-600 uppercase tracking-widest">
             ...
             <div>© {new Date().getFullYear()} {fullName}</div>
          </div>
        </footer>
